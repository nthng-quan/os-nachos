...
class Machine {
  public:
    ...
    // Data structures accessible to the Nachos kernel -- main memory and
    // the page table/TLB.
    //
    ...
    //	the contents of the TLB.  But the kernel can use any data
    // structure 	it wants (eg, segmented paging) for handling TLB cache
    // misses.
    //
