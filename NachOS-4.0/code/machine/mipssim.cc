...
void Machine::OneInstruction(Instruction *instr)
{
	...
	case OP_LWL:
		...
		// asks for is a arbitrary) This is the whole purpose of LWL and
		// LWR etc. Then the switch uses  3 - (tmp & 0x3)  instead of
		// (tmp & 0x3)
		...
		case 2:
			nextLoadValue =
				(nextLoadValue & 0xffff) | (value << 16);
			break;
		case 3:
			nextLoadValue =
				(nextLoadValue & 0xffffff) | (value << 24);
			break;
		}
		nextLoadReg = instr->rt;
		break;
